...
<div class="header-actions"><span style="font-size:13px;color:#64748b;"><?= count($rows) ?> records</span></div></header>
<table>
<thead><tr><th>Student</th><th>School</th><th>Year</th><th>Grade Level</th><th>GWA</th><th>Remarks</th></tr></thead>
<tbody>
<?php if (empty($rows)): ?>
<tr><td colspan="6" style="text-align:center;padding:30px;color:#94a3b8;">No academic history records found.</td></tr>
