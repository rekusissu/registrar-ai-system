...
//  New document request form (gen-2)
// ============================================================
...
<div class="panel" style="max-width: 640px; margin: 0 auto;">
    ...
    <form method="POST" id="addDocumentForm" style="margin-top:16px;">
        ...
        <div class="modal-footer" style="padding-top:16px;border-top:1px solid #e2e8f0;margin-top:8px;">
